...
Queue *create (int size) {
  ...
  q->back = 0;
  q->size = size;
  q->array = (int *)malloc(size * sizeof(int)); //aqui está criando o array com 10 posições de cada um dos n carretéis
  return q; //está retornando a posição da memória aonde este array de 10 posições está alocado
}
